...
class TeamEditingView extends GetView<TeamEditingController> {
  final String ID;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 1,
        title: Text("팀정보 수정하기", style: semibold_f00_18),
        actions: [
          IconButton(
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    GetBuilder<TeamEditingController>(
                      init: controller,
                      builder: (_) => Wrap(
                        spacing: 8,
                        runSpacing: 2,
                          ...
                          child: TextButton(
                            onPressed: (){
                              if (controller.teamType == '공모전/해커톤' && controller.relatedContest!=''){
                                print("case: 1");
                                controller.TeamEditing(context, 1);
                              } else if (controller.teamType == '대외활동' && controller.relatedOutdoor!=''){
                                print("case: 2");
                                controller.TeamEditing(context, 2);
                              } else {
                                print("case: 0");
                                controller.TeamEditing(context, 0);
                              }
                            },
  ...
  FilterChip buildFilterChip(TeamEditingController _, int index) {
    return FilterChip(
  ...
  FilterChip buildGenderFilterChip(TeamEditingController _, int index) {
    return FilterChip(
